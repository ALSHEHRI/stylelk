...
<div class="row story-wrapper">
	...
	<div class="col-md-6 story-content">
	    ...
	    <ul class="nav nav-align-right nav-padding-none interative"><li><a href="<?php echo $post_link; ?>"><?php echo getRedditShareCount($post_link)+getPinterestShareCount($post_link)+getTwitterShareCount($post_link)+getFacebookShareCount($post_link);?> <?php _E('Shares')?></a></li><li class="divider">/</li><li><a href="<?php echo get_permalink(get_the_ID());?>"><?php echo getPostViews($post_id); ?></a></li><li class="divider">/</li><li><a href="<?php echo $post_link;?>"><span class="disqus-comment-count"  data-role="mobile" data-disqus-url="<?php echo $post_link;?>">0 Comments</span></a></li></ul>
